...
Box.create!(title: "Cool Basic", month_year: Date.today.months_ago(2), plan_id: 1, shipped: true)
Box.create!(title: "Fun Basic", month_year: Date.today.months_ago(1), plan_id: 1)
Box.create!(title: "Autumn Basic", month_year: Date.today, plan_id: 1)

Box.create!(title: "Cool Standard", month_year: Date.today.months_ago(2), plan_id: 2, shipped: true)
...
Box.create!(title: "Cool Premium", month_year: Date.today.months_ago(2), plan_id: 3, shipped: true)
